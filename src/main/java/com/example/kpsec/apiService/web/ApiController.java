...
public class ApiController {
    ...
    public CommonResult getMaxSumCustomer() throws Exception {
        ...
        return responseService.getSimpleResult(list, "");
    }
    ...
    public CommonResult getSumAmt(@ApiParam(value = "관리점명", required = true) @RequestParam String brName) throws Exception {
        ...
        if(map == null) return responseService.getFailResult(ResponseService.CommonResponse.DATA_NOT_FOUND);
        return responseService.getSimpleResult(map, "");
    }
}